        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 px-5 sm:px-8 md:px-10 w-full lc-padding">
                <div className="flex justify-center mb-4 sm:mb-6 md:mb-8 lc-badge-wrap">
                  <span
                ...
                <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-center tracking-tight leading-[1.15] mb-2 sm:mb-4 lc-title">
                ...
                <p className="text-center text-xs sm:text-sm md:text-base text-white/50 font-light mb-5 sm:mb-8 max-w-xs mx-auto lc-subtitle">
                  Маркет виджетов в стиле отрывного календаря для iOS.
                </p>

                <p className="text-center text-[11px] sm:text-sm text-white/55 font-light inline-flex items-center justify-center gap-2 w-full lc-store">
                ...
                <p className="text-center text-white/25 text-[9px] sm:text-[10px] mt-5 sm:mt-8 lc-copyright">
            ...
            >
              ...
              <div className="relative z-10 px-5 sm:px-8 md:px-10 w-full lc-padding">
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-center text-white/80 mb-5 sm:mb-8 lc-features-title">
                  Возможности
                </h2>

                <div className="grid grid-cols-2 gap-3 sm:gap-5 mb-5 sm:mb-8 lc-features-grid">
                  {features.map((f) => (
                    <div key={f.title} className="flex flex-col gap-1.5 sm:gap-2">
                      <div
                        className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl flex items-center justify-center lc-feature-icon"
                        style={{
                      ...
                      <h3 className="text-[11px] sm:text-sm font-semibold text-white/80 lc-feature-title">{f.title}</h3>
                      <p className="text-[10px] sm:text-xs text-white/40 font-light leading-relaxed lc-feature-desc">{f.desc}</p>
                    </div>
                  ))}
                </div>

                <p className="text-center text-white/30 text-[10px] sm:text-[11px] lc-back-hint">
