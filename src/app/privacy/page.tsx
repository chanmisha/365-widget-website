      ...
      <div className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
        ...
        <div className="space-y-8 text-sm sm:text-base leading-relaxed text-white/75">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                Информация о совершённых покупках обрабатывается App Store
                (Apple Inc.) и платёжными провайдерами. Мы не получаем и не
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>Мы не собираем геолокацию.</li>
              <li>Мы не получаем доступ к контактам, фото и микрофону.</li>
              <li>Мы не используем сторонние рекламные трекеры.</li>
          ...
          <section>
            ...
            <p>
              ...
              функциональности Приложения, обработки покупок, обеспечения
          ...
          <section>
            ...
            <p>
              Пользовательский контент (заметки, настройки) хранится локально
              на устройстве пользователя в защищённом контейнере iOS. Мы
              применяем технические и организационные меры для защиты данных
          ...
          <section>
            ...
            <p>
              Приложение распространяется через App Store и использует
              стандартные API Apple (StoreKit, WidgetKit). Обработка платежей
              осуществляется Apple Inc. в соответствии с их политикой
              конфиденциальности.
            </p>
          </section>
